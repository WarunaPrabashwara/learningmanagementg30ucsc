                              ...
                              Row(
                                children: [
                                  Padding(
                                    ...
                                    child: AutoSizeText("By HANT RANATUNGE",style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold)),
                                  ),
                                  Padding(
                          ...
                          children: [
                            Row(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.fromLTRB(8.0, 8.0, 1.0, 8.0),
                                  child: AutoSizeText("By PWAM JAYASOORIYA",style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold)),
                                ),
                                Padding(
                                  padding: const EdgeInsets.fromLTRB(8.0, 8.0, 0.0, 8.0),
                                  child: AutoSizeText("2021/07/16 1:30 PM",style: TextStyle(fontSize: 16.0, fontStyle: FontStyle.italic)),
