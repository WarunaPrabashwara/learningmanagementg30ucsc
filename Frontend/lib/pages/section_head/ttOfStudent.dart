...
*/
class ttofstudent extends StatefulWidget {
  ttofstudent({Key key, this.title}) : super(key: key);
  @override
  final String title;
  State<StatefulWidget> createState() => new _ttOfStudent();
}

class _ttOfStudent extends State<ttofstudent> {
