...
class viewAnassignsubjctwithteacherandlass extends StatefulWidget {
...
class respAnnouncement {
  ...
  respAnnouncement(this.id, this.name, );
...
class _UserMgtState extends State<viewAnassignsubjctwithteacherandlass> {
  int i =0;
